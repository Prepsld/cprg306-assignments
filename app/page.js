  ...
  return (
    <main className="bg-gray-900 text-white p-8">
      ...
      <div className="flex justify-center">
        ...
        <Link href="/week7" className="text-blue-400 mx-2 hover:text-blue-600">
          Week 7
        </Link>
        <Link href="/week8" className="text-blue-400 mx-2 hover:text-blue-600">
          Week 8
        </Link>
        <Link href="/week10" className="text-blue-400 mx-2 hover:text-blue-600">
          Week 10!!
        </Link>
      </div>
    </main>
